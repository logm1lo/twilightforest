...
public class TwilightItemTier {
	...
	public static final Tier IRONWOOD = TierSortingRegistry.registerTier(
			new SimpleTier(2, 512, 6.5F, 2, 25, BlockTags.create(TwilightForestMod.prefix("needs_ironwood_tool")), () -> Ingredient.of(TFItems.IRONWOOD_INGOT.value())),
	...
	public static final Tier FIERY = TierSortingRegistry.registerTier(
			new SimpleTier(4, 1024, 9F, 4, 10, BlockTags.create(TwilightForestMod.prefix("needs_fiery_tool")), () -> Ingredient.of(TFItems.FIERY_INGOT.value())),
	...
	public static final Tier STEELEAF = TierSortingRegistry.registerTier(
			new SimpleTier(3, 131, 8.0F, 3, 9, BlockTags.create(TwilightForestMod.prefix("needs_steeleaf_tool")), () -> Ingredient.of(TFItems.STEELEAF_INGOT.value())),
	...
	public static final Tier KNIGHTMETAL = TierSortingRegistry.registerTier(
			new SimpleTier(3, 512, 8.0F, 3, 8, BlockTags.create(TwilightForestMod.prefix("needs_knightmetal_tool")), () -> Ingredient.of(TFItems.KNIGHTMETAL_INGOT.value())),
	...
	public static final Tier GIANT = TierSortingRegistry.registerTier(
			new SimpleTier(1, 1024, 4.0F, 1.0F, 5, BlockTags.create(TwilightForestMod.prefix("needs_giant_tool")), () -> Ingredient.of(TFBlocks.GIANT_COBBLESTONE.value())),
