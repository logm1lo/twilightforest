...
public class TFLoot {
	...
	public static final DeferredHolder<LootItemFunctionType, LootItemFunctionType> MULTIPLAYER_MULTIPLIER = FUNCTIONS.register("multiplayer_addition", () -> new LootItemFunctionType(MultiplayerBasedAdditionLootFunction.CODEC));
