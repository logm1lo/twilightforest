...
public class TFItems {
	...
	public static final DeferredItem<Item> NAGA_CHESTPLATE = ITEMS.register("naga_chestplate", () -> new ArmorItem(TFArmorMaterials.NAGA, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> NAGA_LEGGINGS = ITEMS.register("naga_leggings", () -> new ArmorItem(TFArmorMaterials.NAGA, ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<ArmorItem> IRONWOOD_HELMET = ITEMS.register("ironwood_helmet", () -> new ArmorItem(TFArmorMaterials.IRONWOOD, ArmorItem.Type.HELMET, new Item.Properties()));
	...
	public static final DeferredItem<ArmorItem> FIERY_HELMET = ITEMS.register("fiery_helmet", () -> new FieryArmorItem(TFArmorMaterials.FIERY, ArmorItem.Type.HELMET, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<ArmorItem> FIERY_CHESTPLATE = ITEMS.register("fiery_chestplate", () -> new FieryArmorItem(TFArmorMaterials.FIERY, ArmorItem.Type.CHESTPLATE, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<ArmorItem> FIERY_LEGGINGS = ITEMS.register("fiery_leggings", () -> new FieryArmorItem(TFArmorMaterials.FIERY, ArmorItem.Type.LEGGINGS, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<ArmorItem> FIERY_BOOTS = ITEMS.register("fiery_boots", () -> new FieryArmorItem(TFArmorMaterials.FIERY, ArmorItem.Type.BOOTS, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> FIERY_SWORD = ITEMS.register("fiery_sword", () -> new FierySwordItem(TwilightItemTier.FIERY, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON).attributes(SwordItem.createAttributes(TwilightItemTier.FIERY, 3, -2.4F))));
	public static final DeferredItem<Item> FIERY_PICKAXE = ITEMS.register("fiery_pickaxe", () -> new FieryPickItem(TwilightItemTier.FIERY, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON).attributes(PickaxeItem.createAttributes(TwilightItemTier.FIERY, 1.0F, -2.8F))));
	public static final DeferredItem<Item> STEELEAF_INGOT = ITEMS.register("steeleaf_ingot", () -> new Item(new Item.Properties()));
	public static final DeferredItem<ArmorItem> STEELEAF_HELMET = ITEMS.register("steeleaf_helmet", () -> new ArmorItem(TFArmorMaterials.STEELEAF, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final DeferredItem<ArmorItem> STEELEAF_CHESTPLATE = ITEMS.register("steeleaf_chestplate", () -> new ArmorItem(TFArmorMaterials.STEELEAF, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final DeferredItem<ArmorItem> STEELEAF_LEGGINGS = ITEMS.register("steeleaf_leggings", () -> new ArmorItem(TFArmorMaterials.STEELEAF, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final DeferredItem<ArmorItem> STEELEAF_BOOTS = ITEMS.register("steeleaf_boots", () -> new ArmorItem(TFArmorMaterials.STEELEAF, ArmorItem.Type.BOOTS, new Item.Properties()));
	public static final DeferredItem<Item> STEELEAF_SWORD = ITEMS.register("steeleaf_sword", () -> new SwordItem(TwilightItemTier.STEELEAF, new Item.Properties().attributes(SwordItem.createAttributes(TwilightItemTier.STEELEAF, 3, -2.4F))));
	public static final DeferredItem<Item> STEELEAF_SHOVEL = ITEMS.register("steeleaf_shovel", () -> new ShovelItem(TwilightItemTier.STEELEAF, new Item.Properties().attributes(ShovelItem.createAttributes(TwilightItemTier.STEELEAF, 1.5F, -3.0F))));
	public static final DeferredItem<Item> STEELEAF_PICKAXE = ITEMS.register("steeleaf_pickaxe", () -> new PickaxeItem(TwilightItemTier.STEELEAF, new Item.Properties().attributes(PickaxeItem.createAttributes(TwilightItemTier.STEELEAF, 1.0F, -2.8F))));
	public static final DeferredItem<Item> STEELEAF_AXE = ITEMS.register("steeleaf_axe", () -> new AxeItem(TwilightItemTier.STEELEAF, new Item.Properties().attributes(AxeItem.createAttributes(TwilightItemTier.STEELEAF, 6.0F, -3.0F))));
	public static final DeferredItem<Item> STEELEAF_HOE = ITEMS.register("steeleaf_hoe", () -> new HoeItem(TwilightItemTier.STEELEAF, new Item.Properties().attributes(HoeItem.createAttributes(TwilightItemTier.STEELEAF, -3.0F, -0.5F))));
	...
	public static final DeferredItem<ArmorItem> KNIGHTMETAL_HELMET = ITEMS.register("knightmetal_helmet", () -> new KnightmetalArmorItem(TFArmorMaterials.KNIGHTMETAL, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final DeferredItem<ArmorItem> KNIGHTMETAL_CHESTPLATE = ITEMS.register("knightmetal_chestplate", () -> new KnightmetalArmorItem(TFArmorMaterials.KNIGHTMETAL, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final DeferredItem<ArmorItem> KNIGHTMETAL_LEGGINGS = ITEMS.register("knightmetal_leggings", () -> new KnightmetalArmorItem(TFArmorMaterials.KNIGHTMETAL, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final DeferredItem<ArmorItem> KNIGHTMETAL_BOOTS = ITEMS.register("knightmetal_boots", () -> new KnightmetalArmorItem(TFArmorMaterials.KNIGHTMETAL, ArmorItem.Type.BOOTS, new Item.Properties()));
	public static final DeferredItem<Item> KNIGHTMETAL_SWORD = ITEMS.register("knightmetal_sword", () -> new KnightmetalSwordItem(TwilightItemTier.KNIGHTMETAL, new Item.Properties().attributes(SwordItem.createAttributes(TwilightItemTier.KNIGHTMETAL, 3, -2.4F))));
	public static final DeferredItem<Item> KNIGHTMETAL_PICKAXE = ITEMS.register("knightmetal_pickaxe", () -> new KnightmetalPickItem(TwilightItemTier.KNIGHTMETAL, new Item.Properties().attributes(PickaxeItem.createAttributes(TwilightItemTier.KNIGHTMETAL, 1, -2.8F))));
	public static final DeferredItem<Item> KNIGHTMETAL_AXE = ITEMS.register("knightmetal_axe", () -> new KnightmetalAxeItem(TwilightItemTier.KNIGHTMETAL, new Item.Properties().attributes(AxeItem.createAttributes(TwilightItemTier.KNIGHTMETAL, 6F, TwilightItemTier.KNIGHTMETAL.getSpeed() * 0.05f - 3.4f))));
	...
	public static final DeferredItem<ArmorItem> PHANTOM_HELMET = ITEMS.register("phantom_helmet", () -> new PhantomArmorItem(TFArmorMaterials.PHANTOM, ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<ArmorItem> PHANTOM_CHESTPLATE = ITEMS.register("phantom_chestplate", () -> new PhantomArmorItem(TFArmorMaterials.PHANTOM, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<ArmorItem> ARCTIC_HELMET = ITEMS.register("arctic_helmet", () -> new ArcticArmorItem(TFArmorMaterials.ARCTIC, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final DeferredItem<ArmorItem> ARCTIC_CHESTPLATE = ITEMS.register("arctic_chestplate", () -> new ArcticArmorItem(TFArmorMaterials.ARCTIC, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final DeferredItem<ArmorItem> ARCTIC_LEGGINGS = ITEMS.register("arctic_leggings", () -> new ArcticArmorItem(TFArmorMaterials.ARCTIC, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final DeferredItem<ArmorItem> ARCTIC_BOOTS = ITEMS.register("arctic_boots", () -> new ArcticArmorItem(TFArmorMaterials.ARCTIC, ArmorItem.Type.BOOTS, new Item.Properties()));
	...
	public static final DeferredItem<ArmorItem> YETI_HELMET = ITEMS.register("yeti_helmet", () -> new YetiArmorItem(TFArmorMaterials.YETI, ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<ArmorItem> YETI_CHESTPLATE = ITEMS.register("yeti_chestplate", () -> new YetiArmorItem(TFArmorMaterials.YETI, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<ArmorItem> YETI_LEGGINGS = ITEMS.register("yeti_leggings", () -> new YetiArmorItem(TFArmorMaterials.YETI, ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<ArmorItem> YETI_BOOTS = ITEMS.register("yeti_boots", () -> new YetiArmorItem(TFArmorMaterials.YETI, ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> ICE_SWORD = ITEMS.register("ice_sword", () -> new IceSwordItem(TwilightItemTier.ICE, new Item.Properties().attributes(SwordItem.createAttributes(TwilightItemTier.ICE, 3, -2.4F))));
	public static final DeferredItem<Item> GLASS_SWORD = ITEMS.register("glass_sword", () -> new GlassSwordItem(TwilightItemTier.GLASS, new Item.Properties().setNoRepair().rarity(Rarity.UNCOMMON).attributes(SwordItem.createAttributes(TwilightItemTier.GLASS, 3, -2.4F))));
	public static final DeferredItem<Item> MAGIC_BEANS = ITEMS.register("magic_beans", () -> new MagicBeansItem(new Item.Properties()));
	public static final DeferredItem<Item> GIANT_PICKAXE = ITEMS.register("giant_pickaxe", () -> new GiantPickItem(TwilightItemTier.GIANT, new Item.Properties().attributes(GiantPickItem.createGiantAttributes(TwilightItemTier.GIANT, 8, -3.5F))));
	public static final DeferredItem<Item> GIANT_SWORD = ITEMS.register("giant_sword", () -> new GiantSwordItem(TwilightItemTier.GIANT, new Item.Properties().attributes(GiantSwordItem.createGiantAttributes(TwilightItemTier.GIANT, 10, -3.5F))));
