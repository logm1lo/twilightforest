...
public final class TFSounds {
	...
	public static void registerParrotSounds() {
		Parrot.MOB_SOUND_MAP.put(TFEntities.ALPHA_YETI.value(), ALPHA_YETI_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.BLOCKCHAIN_GOBLIN.value(), REDCAP_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.CARMINITE_BROODLING.value(), SoundEvents.PARROT_IMITATE_SPIDER);
		Parrot.MOB_SOUND_MAP.put(TFEntities.CARMINITE_GOLEM.value(), CARMINITE_GOLEM_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.FIRE_BEETLE.value(), SoundEvents.PARROT_IMITATE_SPIDER);
		Parrot.MOB_SOUND_MAP.put(TFEntities.CARMINITE_GHASTLING.value(), SoundEvents.PARROT_IMITATE_GHAST);
		Parrot.MOB_SOUND_MAP.put(TFEntities.CARMINITE_GHASTGUARD.value(), SoundEvents.PARROT_IMITATE_GHAST);
		Parrot.MOB_SOUND_MAP.put(TFEntities.HEDGE_SPIDER.value(), SoundEvents.PARROT_IMITATE_SPIDER);
		Parrot.MOB_SOUND_MAP.put(TFEntities.HELMET_CRAB.value(), SoundEvents.PARROT_IMITATE_SPIDER);
		Parrot.MOB_SOUND_MAP.put(TFEntities.HOSTILE_WOLF.value(), HOSTILE_WOLF_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.HYDRA.value(), HYDRA_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.STABLE_ICE_CORE.value(), ICE_CORE_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.KING_SPIDER.value(), SoundEvents.PARROT_IMITATE_SPIDER);
		Parrot.MOB_SOUND_MAP.put(TFEntities.KOBOLD.value(), KOBOLD_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.LICH.value(), SoundEvents.PARROT_IMITATE_BLAZE);
		Parrot.MOB_SOUND_MAP.put(TFEntities.MAZE_SLIME.value(), SoundEvents.PARROT_IMITATE_SLIME);
		Parrot.MOB_SOUND_MAP.put(TFEntities.LICH_MINION.value(), SoundEvents.PARROT_IMITATE_ZOMBIE);
		Parrot.MOB_SOUND_MAP.put(TFEntities.MINOSHROOM.value(), MINOTAUR_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.MINOTAUR.value(), MINOTAUR_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.MIST_WOLF.value(), HOSTILE_WOLF_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.MOSQUITO_SWARM.value(), MOSQUITO_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.NAGA.value(), NAGA_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.KNIGHT_PHANTOM.value(), WRAITH_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.PINCH_BEETLE.value(), SoundEvents.PARROT_IMITATE_SPIDER);
		Parrot.MOB_SOUND_MAP.put(TFEntities.REDCAP.value(), REDCAP_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.REDCAP_SAPPER.value(), REDCAP_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.SKELETON_DRUID.value(), SoundEvents.PARROT_IMITATE_SKELETON);
		Parrot.MOB_SOUND_MAP.put(TFEntities.SLIME_BEETLE.value(), SoundEvents.PARROT_IMITATE_SLIME);
		Parrot.MOB_SOUND_MAP.put(TFEntities.SNOW_GUARDIAN.value(), ICE_CORE_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.SNOW_QUEEN.value(), ICE_CORE_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.SWARM_SPIDER.value(), SoundEvents.PARROT_IMITATE_SPIDER);
		Parrot.MOB_SOUND_MAP.put(TFEntities.TOWERWOOD_BORER.value(), SoundEvents.PARROT_IMITATE_SILVERFISH);
		Parrot.MOB_SOUND_MAP.put(TFEntities.DEATH_TOME.value(), DEATH_TOME_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.UR_GHAST.value(), SoundEvents.PARROT_IMITATE_GHAST);
		Parrot.MOB_SOUND_MAP.put(TFEntities.WINTER_WOLF.value(), HOSTILE_WOLF_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.WRAITH.value(), WRAITH_PARROT.value());
		Parrot.MOB_SOUND_MAP.put(TFEntities.YETI.value(), ALPHA_YETI_PARROT.value());
	}
}
