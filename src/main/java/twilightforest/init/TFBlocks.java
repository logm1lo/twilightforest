...
public class TFBlocks {
	...
	public static final RegistryObject<Block> CANDELABRA = register("candelabra", () -> new CandelabraBlock(BlockBehaviour.Properties.of().lightLevel(state -> state.getValue(AbstractLightableBlock.LIGHTING) == AbstractLightableBlock.Lighting.NORMAL ? 15 : state.getValue(AbstractLightableBlock.LIGHTING) == AbstractLightableBlock.Lighting.OMINOUS ? 7 : 0).mapColor(MapColor.STONE).strength(1.5F)));
...
//	public static final RegistryObject<Block> FINAL_CASTLE_MINIATURE_STRUCTURE = register("final_castle_miniature_structure", () -> new MiniatureStructureBlock(BlockBehaviour.Properties.copy(TWILIGHT_PORTAL_MINIATURE_STRUCTURE.get())));
	...
	public static final RegistryObject<FlowerPotBlock> POTTED_GLACIALIS = BLOCKS.register("potted_glacialis", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, GLACIALIS, BlockBehaviour.Properties.copy(Blocks.FLOWER_POT)));
