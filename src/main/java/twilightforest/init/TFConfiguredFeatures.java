...
public final class TFConfiguredFeatures {
	...
	public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
		...
		context.register(BIG_MUSHGLOOM, new ConfiguredFeature<>(TFFeatures.BIG_MUSHGLOOM.value(), new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(TFBlocks.HUGE_MUSHGLOOM.value().defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.TRUE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), BlockStateProvider.simple(TFBlocks.HUGE_MUSHGLOOM_STEM.value().defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.FALSE).setValue(HugeMushroomBlock.DOWN, Boolean.FALSE)), 1)));
		context.register(FALLEN_LEAVES, new ConfiguredFeature<>(TFFeatures.FALLEN_LEAVES.value(), FeatureConfiguration.NONE));
		context.register(MAYAPPLE, new ConfiguredFeature<>(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.MAYAPPLE.value())))));
		context.register(FIDDLEHEAD, new ConfiguredFeature<>(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.FIDDLEHEAD.value())))));
		context.register(FIRE_JET, new ConfiguredFeature<>(TFFeatures.FIRE_JET.value(), new BlockStateConfiguration(TFBlocks.FIRE_JET.value().defaultBlockState())));
		context.register(FOUNDATION, new ConfiguredFeature<>(TFFeatures.FOUNDATION.value(), NoneFeatureConfiguration.NONE));
		context.register(GROVE_RUINS, new ConfiguredFeature<>(TFFeatures.GROVE_RUINS.value(), NoneFeatureConfiguration.NONE));
		context.register(HOLLOW_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_HOLLOW_LOG.value(), NoneFeatureConfiguration.NONE));
		context.register(HOLLOW_STUMP, new ConfiguredFeature<>(TFFeatures.HOLLOW_STUMP.value(), TreeConfigurations.HOLLOW_TREE));
		context.register(HUGE_LILY_PAD, new ConfiguredFeature<>(TFFeatures.HUGE_LILY_PAD.value(), NoneFeatureConfiguration.NONE));
		context.register(HUGE_WATER_LILY, new ConfiguredFeature<>(TFFeatures.HUGE_WATER_LILY.value(), NoneFeatureConfiguration.NONE));
		context.register(CICADA_LAMPPOST, new ConfiguredFeature<>(TFFeatures.LAMPPOSTS.value(), new BlockStateConfiguration(TFBlocks.CICADA_JAR.value().defaultBlockState())));
		context.register(FIREFLY_LAMPPOST, new ConfiguredFeature<>(TFFeatures.LAMPPOSTS.value(), new BlockStateConfiguration(TFBlocks.FIREFLY_JAR.value().defaultBlockState())));
		context.register(MONOLITH, new ConfiguredFeature<>(TFFeatures.MONOLITH.value(), NoneFeatureConfiguration.NONE));
		context.register(MUSHGLOOM_CLUSTER, new ConfiguredFeature<>(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.MUSHGLOOM.value())))));
		context.register(MYCELIUM_BLOB, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB.value(), new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.MYCELIUM), BlockPredicate.matchesBlocks(Blocks.GRASS_BLOCK), UniformInt.of(4, 6), 3)));
		context.register(OUTSIDE_STALAGMITE, new ConfiguredFeature<>(TFFeatures.CAVE_STALACTITE.value(), NoneFeatureConfiguration.NONE));
		context.register(PLANT_ROOTS, new ConfiguredFeature<>(TFFeatures.UNDERGROUND_PLANTS.value(), new BlockStateConfiguration(TFBlocks.ROOT_STRAND.value().defaultBlockState())));
		context.register(PUMPKIN_LAMPPOST, new ConfiguredFeature<>(TFFeatures.LAMPPOSTS.value(), new BlockStateConfiguration(Blocks.JACK_O_LANTERN.defaultBlockState())));
		context.register(SMOKER, new ConfiguredFeature<>(TFFeatures.FIRE_JET.value(), new BlockStateConfiguration(TFBlocks.SMOKER.value().defaultBlockState())));
		context.register(STONE_CIRCLE, new ConfiguredFeature<>(TFFeatures.STONE_CIRCLE.value(), NoneFeatureConfiguration.NONE));
		context.register(THORNS, new ConfiguredFeature<>(TFFeatures.THORNS.value(), new ThornsConfig(7, 3, 3, 50)));
		context.register(TORCH_BERRIES, new ConfiguredFeature<>(TFFeatures.UNDERGROUND_PLANTS.value(), new BlockStateConfiguration(TFBlocks.TORCHBERRY_PLANT.value().defaultBlockState().setValue(TorchberryPlantBlock.HAS_BERRIES, true))));
		context.register(TROLL_ROOTS, new ConfiguredFeature<>(TFFeatures.TROLL_VINES.value(), new BlockStateConfiguration(TFBlocks.TROLLVIDR.value().defaultBlockState())));
		context.register(VANILLA_ROOTS, new ConfiguredFeature<>(TFFeatures.UNDERGROUND_PLANTS.value(), new BlockStateConfiguration(Blocks.HANGING_ROOTS.defaultBlockState())));
		context.register(WEBS, new ConfiguredFeature<>(TFFeatures.WEBS.value(), NoneFeatureConfiguration.NONE));
		context.register(WOOD_ROOTS_SPREAD, new ConfiguredFeature<>(TFFeatures.WOOD_ROOTS.value(), new RootConfig(TreeDecorators.ROOT_BLEND_PROVIDER, BlockStateProvider.simple(TFBlocks.LIVEROOT_BLOCK.value()))));
		context.register(SNOW_UNDER_TREES, new ConfiguredFeature<>(TFFeatures.SNOW_UNDER_TREES.value(), NoneFeatureConfiguration.NONE));

		context.register(TF_OAK_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG.value(), new HollowLogConfig(TFBlocks.TWILIGHT_OAK_LOG.value().defaultBlockState(), TFBlocks.HOLLOW_TWILIGHT_OAK_LOG_HORIZONTAL.value().defaultBlockState())));
		context.register(CANOPY_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG.value(), new HollowLogConfig(TFBlocks.CANOPY_LOG.value().defaultBlockState(), TFBlocks.HOLLOW_CANOPY_LOG_HORIZONTAL.value().defaultBlockState())));
		context.register(MANGROVE_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG.value(), new HollowLogConfig(TFBlocks.MANGROVE_LOG.value().defaultBlockState(), TFBlocks.HOLLOW_MANGROVE_LOG_HORIZONTAL.value().defaultBlockState())));
		context.register(OAK_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG.value(), new HollowLogConfig(Blocks.OAK_LOG.defaultBlockState(), TFBlocks.HOLLOW_OAK_LOG_HORIZONTAL.value().defaultBlockState())));
		context.register(SPRUCE_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG.value(), new HollowLogConfig(Blocks.SPRUCE_LOG.defaultBlockState(), TFBlocks.HOLLOW_SPRUCE_LOG_HORIZONTAL.value().defaultBlockState())));
		context.register(BIRCH_FALLEN_LOG, new ConfiguredFeature<>(TFFeatures.FALLEN_SMALL_LOG.value(), new HollowLogConfig(Blocks.BIRCH_LOG.defaultBlockState(), TFBlocks.HOLLOW_BIRCH_LOG_HORIZONTAL.value().defaultBlockState())));
		...
		context.register(DARK_MUSHGLOOMS, new ConfiguredFeature<>(TFFeatures.DARK_FOREST_PLACER.value(), FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.MUSHGLOOM.value())), List.of(Blocks.GRASS_BLOCK), 50)));
		context.register(DARK_PUMPKINS, new ConfiguredFeature<>(TFFeatures.DARK_FOREST_PLACER.value(), FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.PUMPKIN)), List.of(Blocks.GRASS_BLOCK), 50)));
		context.register(DARK_GRASS, new ConfiguredFeature<>(TFFeatures.DARK_FOREST_PLACER.value(), FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.GRASS)), List.of(Blocks.GRASS_BLOCK), 128)));
		context.register(DARK_FERNS, new ConfiguredFeature<>(TFFeatures.DARK_FOREST_PLACER.value(), FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.FERN)), List.of(Blocks.GRASS_BLOCK), 128)));
		context.register(DARK_MUSHROOMS, new ConfiguredFeature<>(TFFeatures.DARK_FOREST_PLACER.value(), FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.BROWN_MUSHROOM)), List.of(Blocks.GRASS_BLOCK), 50)));
		context.register(DARK_DEAD_BUSHES, new ConfiguredFeature<>(TFFeatures.DARK_FOREST_PLACER.value(), FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.DEAD_BUSH)), List.of(Blocks.GRASS_BLOCK), 50)));

		context.register(UBEROUS_SOIL_PATCH_BIG, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB.value(), new DiskConfiguration(RuleBasedBlockStateProvider.simple(TFBlocks.UBEROUS_SOIL.value()), BlockPredicate.matchesBlocks(Blocks.PODZOL, Blocks.COARSE_DIRT, Blocks.DIRT), UniformInt.of(4, 8), 1)));
		context.register(TROLL_CAVE_MYCELIUM, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB.value(), new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.MYCELIUM), BlockPredicate.matchesBlocks(Blocks.STONE, TFBlocks.DEADROCK.value()), UniformInt.of(3, 5), 0)));
		context.register(TROLL_CAVE_DIRT, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB.value(), new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.DIRT), BlockPredicate.matchesBlocks(Blocks.STONE, TFBlocks.DEADROCK.value()), UniformInt.of(2, 5), 0)));
		context.register(UBEROUS_SOIL_PATCH_SMALL, new ConfiguredFeature<>(TFFeatures.MYCELIUM_BLOB.value(), new DiskConfiguration(RuleBasedBlockStateProvider.simple(TFBlocks.UBEROUS_SOIL.value()), BlockPredicate.matchesBlocks(Blocks.PODZOL, Blocks.COARSE_DIRT, Blocks.DIRT), UniformInt.of(2, 3), 0)));
		...
		context.register(DARKWOOD_TREE, new ConfiguredFeature<>(TFFeatures.DARK_CANOPY_TREE.value(), TreeConfigurations.DARKWOOD_TREE));
		context.register(HOMEGROWN_DARKWOOD_TREE, new ConfiguredFeature<>(TFFeatures.DARK_CANOPY_TREE.value(), TreeConfigurations.HOMEGROWN_DARKWOOD_TREE));
		context.register(DARKWOOD_LANTERN_TREE, new ConfiguredFeature<>(TFFeatures.DARK_CANOPY_TREE.value(), TreeConfigurations.DARKWOOD_LANTERN_TREE));
		context.register(TIME_TREE, new ConfiguredFeature<>(TFFeatures.TREE_OF_TIME.value(), TreeConfigurations.TIME_TREE));
		context.register(TRANSFORMATION_TREE, new ConfiguredFeature<>(Feature.TREE, TreeConfigurations.TRANSFORM_TREE));
		context.register(MINING_TREE, new ConfiguredFeature<>(TFFeatures.MINERS_TREE.value(), TreeConfigurations.MINING_TREE));
		context.register(SORTING_TREE, new ConfiguredFeature<>(Feature.TREE, TreeConfigurations.SORT_TREE));
		context.register(FOREST_CANOPY_OAK_TREE, new ConfiguredFeature<>(TFFeatures.CANOPY_OAK.value(), TreeConfigurations.FOREST_CANOPY_OAK));
		context.register(SAVANNAH_CANOPY_OAK_TREE, new ConfiguredFeature<>(TFFeatures.CANOPY_OAK.value(), TreeConfigurations.SAVANNAH_CANOPY_OAK));
		context.register(HOLLOW_TREE, new ConfiguredFeature<>(TFFeatures.HOLLOW_TREE.value(), TreeConfigurations.HOLLOW_TREE));
	...
	private static void registerTemplateFeatures(BootstapContext<ConfiguredFeature<?, ?>> context) {
		...
		context.register(SIMPLE_WELL, new ConfiguredFeature<>(TFFeatures.SIMPLE_WELL.value(), simpleWellConfig));
		...
		context.register(FANCY_WELL, new ConfiguredFeature<>(TFFeatures.FANCY_WELL.value(), fancyWellConfig));
		...
		context.register(DRUID_HUT, new ConfiguredFeature<>(TFFeatures.DRUID_HUT.value(), hutConfig));

		context.register(GRAVEYARD, new ConfiguredFeature<>(TFFeatures.GRAVEYARD.value(), FeatureConfiguration.NONE));
	}
}