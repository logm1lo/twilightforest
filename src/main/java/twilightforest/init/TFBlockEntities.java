...
public class TFBlockEntities {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<CandelabraBlockEntity>> CANDELABRA = BLOCK_ENTITIES.register("candelabra", () ->
			BlockEntityType.Builder.of(CandelabraBlockEntity::new, TFBlocks.CANDELABRA.value()).build(null));
	...
	public static void registerTileEntityRenders() {
		...
		BlockEntityRenderers.register(CANDELABRA.value(), CandelabraTileEntityRenderer::new);
	}
}
