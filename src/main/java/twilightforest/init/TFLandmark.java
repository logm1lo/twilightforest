...
public class TFLandmark {
	...
	public static final TFLandmark SMALL_HILL = new TFLandmark( 1, "small_hollow_hill", true, true) {
		...
		public StructurePiece provideFirstPiece(StructureTemplateManager structureManager, ChunkGenerator chunkGenerator, RandomSource rand, int x, int y, int z) {
			return new HollowHillComponent(TFStructurePieceTypes.TFHill.get(), 0, size, x - 3, y - 2, z - 3, RectangleLatticeIterator.TriangularLatticeConfig.DEFAULT);
		}
	};
	public static final TFLandmark MEDIUM_HILL = new TFLandmark( 2, "medium_hollow_hill", true, true) {
		@Override
		public StructurePiece provideFirstPiece(StructureTemplateManager structureManager, ChunkGenerator chunkGenerator, RandomSource rand, int x, int y, int z) {
			return new HollowHillComponent(TFStructurePieceTypes.TFHill.get(), 0, size, x - 7, y - 5, z - 7, RectangleLatticeIterator.TriangularLatticeConfig.DEFAULT);
		}
	};
	public static final TFLandmark LARGE_HILL = new TFLandmark( 3, "large_hollow_hill", true, true) {
		@Override
		public StructurePiece provideFirstPiece(StructureTemplateManager structureManager, ChunkGenerator chunkGenerator, RandomSource rand, int x, int y, int z) {
			return new HollowHillComponent(TFStructurePieceTypes.TFHill.get(), 0, size, x - 11, y - 5, z - 11, RectangleLatticeIterator.TriangularLatticeConfig.DEFAULT);
		}
	};
