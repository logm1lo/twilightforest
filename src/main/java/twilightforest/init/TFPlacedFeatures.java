...
public class TFPlacedFeatures {
	...
	public static void bootstrap(BootstapContext<PlacedFeature> context) {
		...
		context.register(PLACED_HOLLOW_STUMP, new PlacedFeature(features.getOrThrow(TFConfiguredFeatures.HOLLOW_STUMP), tfFeatureCheckArea(AvoidLandmarkModifier.checkSurface(), 1).build()));
