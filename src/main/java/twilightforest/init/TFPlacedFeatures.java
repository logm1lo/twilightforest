...
public class TFPlacedFeatures {
	...
	public static final ResourceKey<PlacedFeature> PLACED_OAK_BUSH_33 = registerKey("tree/oak_bush_33");
	public static final ResourceKey<PlacedFeature> PLACED_OAK_BUSH_50 = registerKey("tree/oak_bush_50");
	...
	public static void bootstrap(BootstrapContext<PlacedFeature> context) {
		...
		context.register(PLACED_OAK_BUSH_33, new PlacedFeature(features.getOrThrow(TFConfiguredFeatures.OAK_BUSH), tfTreeCheckArea(PlacementUtils.countExtra(1, 1 / 3F, 1), Blocks.OAK_SAPLING.defaultBlockState())));  // 0.33F raise exception
		context.register(PLACED_OAK_BUSH_50, new PlacedFeature(features.getOrThrow(TFConfiguredFeatures.OAK_BUSH), tfTreeCheckArea(PlacementUtils.countExtra(1, 0.5F, 1), Blocks.OAK_SAPLING.defaultBlockState())));  // 0.33F raise exception
