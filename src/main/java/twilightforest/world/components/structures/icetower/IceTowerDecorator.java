...
public class IceTowerDecorator extends TFStructureDecorator {
	...
	public IceTowerDecorator() {
		this.blockState = TFBlocks.AURORA_BLOCK.value().defaultBlockState();
		...
		this.pillarState = TFBlocks.AURORA_PILLAR.value().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Y);
