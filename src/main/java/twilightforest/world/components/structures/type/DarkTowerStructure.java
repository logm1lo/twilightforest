...
public class DarkTowerStructure extends ControlledSpawningStructure {
    ...
    public StructureType<?> type() {
        return TFStructureTypes.DARK_TOWER.value();
    }
    ...
    public static DarkTowerStructure buildDarkTowerConfig(BootstapContext<Structure> context) {
        return new DarkTowerStructure(
                ControlledSpawningConfig.create(List.of(List.of(
                        new MobSpawnSettings.SpawnerData(TFEntities.CARMINITE_GOLEM.value(), 10, 1, 2),
                        ...
                        new MobSpawnSettings.SpawnerData(TFEntities.CARMINITE_GHASTLING.value(), 10, 1, 2),
                        new MobSpawnSettings.SpawnerData(TFEntities.CARMINITE_BROODLING.value(), 10, 4, 4),
                        new MobSpawnSettings.SpawnerData(TFEntities.PINCH_BEETLE.value(), 10, 1, 1)
                ), List.of(
                        // roof ghasts
                        new MobSpawnSettings.SpawnerData(TFEntities.CARMINITE_GHASTGUARD.value(), 10, 1, 2)
                )), List.of(), List.of(
                ...
                new HintConfig(HintConfig.book("darktower", 3), TFEntities.KOBOLD.value()),
