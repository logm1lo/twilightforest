...
public final class BiomeMaker extends BiomeHelper {
	public static List<TerrainColumn> makeBiomeList(HolderGetter<Biome> biomeRegistry, Holder<Biome> undergroundBiome) {
		return List.of(
				...
				biomeColumnWithUnderground(-0.7F, 0.001F, biomeRegistry, TFBiomes.STREAM, undergroundBiome),
				biomeColumnWithUnderground(-1.9998, 0.125F, biomeRegistry, TFBiomes.LAKE, undergroundBiome),
